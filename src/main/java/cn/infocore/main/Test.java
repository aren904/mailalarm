...
import static cn.infocore.protobuf.StmStreamerDrManage.FaultType.META_CLIENT_OFFLINE;

public class Test {
    public static void main(String[] args) throws SQLException {
        GetServerInfoReturn.Builder get = GetServerInfoReturn.newBuilder();
        get.setUuid("c1e5edca-12c1-4b60-bec1-00a83db97214");
...
//        builder.setName("zdy");
//        builder.setId("3");
//        builder.setType(ClientType.MetaDB);
//        List<FaultType> f11 = new ArrayList<>();
//        f11.add(FaultType.META_CLIENT_OFFLINE);
